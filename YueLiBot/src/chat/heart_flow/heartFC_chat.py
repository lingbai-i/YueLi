        ...
        with Timer("回复发送", cycle_timers):
            ...
            if not only_voice:
                try:
                    ...
                    if hasattr(voice_config, "only_voice") and voice_config.only_voice:
                        only_voice = True
                    elif isinstance(voice_config, dict) and voice_config.get("only_voice", False):
                        only_voice = True
                except Exception:
                    pass
