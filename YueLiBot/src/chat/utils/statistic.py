...
logger = get_logger("YueLiBot_statistic")
...
class StatisticOutputTask(AsyncTask):
    ...
    def __init__(self, record_file_path: str = "YueLiBot_statistics.html"):
        # 延迟300秒启动，运行间隔300秒
...
"""
    ...
    <div class="container">
        <div class="toolbar">
            <h1 style="margin: 0;">YueLiBot运行统计报告</h1>
            <div class="right">
        ...
        {joined_tab_content}
        <div class="footer">Made with ❤️ by YueLiBot • 本页会定期自动覆盖生成</div>
    </div>
"""
            + """
<script>
