...
async def get_person_detail(
    person_id: str, YueLiBot_session: Optional[str] = Cookie(None), authorization: Optional[str] = Header(None)
):
    """
    获取人物详细信息
...
async def get_person_stats(YueLiBot_session: Optional[str] = Cookie(None), authorization: Optional[str] = Header(None)):
    """
    获取人物信息统计数据
