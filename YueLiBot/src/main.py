...
from src.chat.core_actions import register_core_actions
...
--------------------------------
如果想要自定义{global_config.bot.nickname}的功能,请查阅：https://docs.YueLi-YueLi.org/manual/usage/
或者遇到了问题，请访问我们的文档:https://docs.YueLi-YueLi.org/
--------------------------------
如果你想要编写或了解插件相关内容，请访问开发文档https://docs.YueLi-YueLi.org/develop/
--------------------------------
如果你需要查阅模型的消耗以及月璃的统计数据，请访问根目录的YueLiBot_statistics.html文件
""")
    ...
    async def _init_components(self):
        ...
        # 将bot.py中的chat_bot.message_process消息处理函数注册到api.py的消息处理列表中
        self.app.register_message_handler(chat_bot.message_process)
        # if hasattr(self.app, "register_custom_message_handler"):
        #     self.app.register_custom_message_handler("message_id_echo", chat_bot.echo_message_id)
